...
```javascript
import { iterators } from 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate@v0.2.1-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate@v0.2.1-deno/mod.js';
