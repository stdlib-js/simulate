...
```javascript
import { iterators } from 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate@v0.3.3-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate@v0.3.3-esm/index.mjs';
