...
```javascript
import { iterators } from 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate@v0.3.1-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate@v0.3.1-deno/mod.js';
